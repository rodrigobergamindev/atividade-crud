...
export class UserValidationAlreadyExistPipe implements PipeTransform {
    ...
    async transform(value: any, metadata: ArgumentMetadata) {
        ...
        const userExist = await this.userService.findByEmail(value.email)
...
@Injectable()
export class UserValidationAddressExist implements PipeTransform {
    ...
    async transform(value: any, metadata: ArgumentMetadata) {
        ...
        const addressExist = await this.userService.findAddress(value)
